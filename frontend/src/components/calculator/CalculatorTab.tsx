          ...
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: 12, marginTop: 12 }}>
            ...
            {(form.oppType !== 'UCaaS Only' || form.advAppEnabled) && (
              <div>
                ...
                <div style={hintStyle}>
                  {(form.oppType === 'Advanced Applications' || (form.advAppEnabled && form.oppType === 'UCaaS Only'))
        ...
        <div style={cardStyle}>
          ...
          <div style={{ marginTop: 16 }}>
            ...
            <SummaryRow label="Advanced App Support" value={calc.advAppSup} overridden={calc.advAppOverridden}
              show={form.oppType === 'Advanced Applications' || (form.advAppEnabled && form.oppType === 'UCaaS Only')} />
